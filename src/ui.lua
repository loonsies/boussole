...
local settings_panel = require('src/overlays/settings_panel')
...
function ui.drawUI()
    ...
    local opened = imgui.Begin('boussole', boussole.visible, bit.bor(ImGuiWindowFlags_NoScrollbar, ImGuiWindowFlags_NoScrollWithMouse))
    ...
    if ui.texture_id and ui.map_texture then
        ...
        if texturePointer then
            ...
            settings_panel.draw(boussole.config, windowPosX, windowPosY, contentMinX, contentMinY, contentMaxX, contentMaxY)
