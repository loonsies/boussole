    ...
    for id, entity in pairs(nearbyEntities) do
        if entity and entity.draw and entity.zoneId == playerZone and not (trackerEnabled and trackerEntities[id]) then
            ...
            if targetPosition ~= nil then
                local isException = boussole.config.sameFloorExceptions and boussole.config.sameFloorExceptions[playerZone] and boussole.config.sameFloorExceptions[playerZone].mob
